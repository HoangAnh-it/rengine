...
LOGGING = {
    ...
    "handlers": {
        ...
        "db": {"class": "logging.handlers.RotatingFileHandler", "formatter": "brief", "filename": "db.log", "maxBytes": 1024, "backupCount": 3},
        "celery": {
    ...
    "loggers": {
        ...
        "": {"handlers": ["brief"], "level": "DEBUG" if DEBUG else "INFO", "propagate": False},
        "celery": {
            "handlers": ["celery"],
