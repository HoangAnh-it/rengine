...
urlpatterns = [
    ...
    path("tools/gpt_vulnerability_report/", LLMVulnerabilityReportGenerator.as_view(), name="gpt_vulnerability_report_generator"),
    path("tools/gpt_get_possible_attacks/", GPTAttackSuggestion.as_view(), name="gpt_get_possible_attacks"),
    path("github/tool/get_latest_releases/", GithubToolCheckGetLatestRelease.as_view(), name="github_tool_latest_release"),
    path("external/tool/get_current_release/", GetExternalToolCurrentVersion.as_view(), name="external_tool_get_current_release"),
    ...
    path("fetch/most_common_vulnerability/", FetchMostCommonVulnerability.as_view(), name="fetch_most_common_vulnerability"),
